...
var _robertjlooby$elm_html5_drag_and_drop$Box$view = function (model) {
	var color = _elm_lang$core$Color$toRgb(model.color);
	var colorCss = A2(
		_elm_lang$core$Basics_ops['++'],
		'rgb(',
		A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							')'))))));
	var boxStyle = _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'backgroundColor', _1: colorCss},
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_danyx23$elm_uuid$Uuid$toString(model.id))
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _robertjlooby$elm_html5_drag_and_drop$Box$Model = F2(
	function (a, b) {
		return {color: a, id: b};
	});

var _robertjlooby$elm_html5_drag_and_drop$BoxList$removeBox = F2(
	function (id, model) {
		var _p0 = A3(
			_elm_lang$core$List$foldr,
			F2(
				function (box, _p1) {
					var _p2 = _p1;
					var _p3 = _p2._1;
					return _elm_lang$core$Native_Utils.eq(box.id, id) ? {
						ctor: '_Tuple2',
						...
						ctor: '_Tuple2',
						_0: _p2._0,
						_1: A2(_elm_lang$core$List_ops['::'], box, _p3)
					};
				}),
			{
				ctor: '_Tuple2',
			...
			model.boxes);
		var removedBox = _p0._0;
		var listWithoutRemovedBox = _p0._1;
		return {
			ctor: '_Tuple2',
			_0: removedBox,
			_1: _elm_lang$core$Native_Utils.update(
				model,
				{boxes: listWithoutRemovedBox})
		};
	});
var _robertjlooby$elm_html5_drag_and_drop$BoxList$boxGenerator = function () {
	var intGenerator = A2(_mgold$elm_random_pcg$Random_Pcg$int, 0, 255);
	var colorGenerator = A4(_mgold$elm_random_pcg$Random_Pcg$map3, _elm_lang$core$Color$rgb, intGenerator, intGenerator, intGenerator);
	return A3(_mgold$elm_random_pcg$Random_Pcg$map2, _robertjlooby$elm_html5_drag_and_drop$Box$Model, colorGenerator, _danyx23$elm_uuid$Uuid$uuidGenerator);
}();
var _robertjlooby$elm_html5_drag_and_drop$BoxList$update = F2(
	function (msg, model) {
		var _p4 = msg;
		var _p5 = A2(_mgold$elm_random_pcg$Random_Pcg$step, _robertjlooby$elm_html5_drag_and_drop$BoxList$boxGenerator, model.seed);
		var newBox = _p5._0;
		var newSeed = _p5._1;
...
var _robertjlooby$elm_html5_drag_and_drop$BoxList$Model = F2(
	function (a, b) {
		return {boxes: a, seed: b};
	});
var _robertjlooby$elm_html5_drag_and_drop$BoxList$AddBox = {ctor: 'AddBox'};
var _robertjlooby$elm_html5_drag_and_drop$BoxList$view = function (model) {
	var boxesStyle = _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'border', _1: 'black solid'},
				{ctor: '_Tuple2', _0: 'overflow', _1: 'auto'},
				{ctor: '_Tuple2', _0: 'width', _1: '110px'},
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(_robertjlooby$elm_html5_drag_and_drop$BoxList$AddBox)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
			...
			A2(_elm_lang$core$List$map, _robertjlooby$elm_html5_drag_and_drop$Box$view, model.boxes)));
};

var _robertjlooby$elm_html5_drag_and_drop$Main$uuidDecoder = A2(
	...
	function (_p0) {
		return A2(
			...
			_danyx23$elm_uuid$Uuid$fromString(_p0));
	});
var _robertjlooby$elm_html5_drag_and_drop$Main$boxListGenerator = A2(
	_mgold$elm_random_pcg$Random_Pcg$map,
	_robertjlooby$elm_html5_drag_and_drop$BoxList$Model(
		_elm_lang$core$Native_List.fromArray(
			[])),
	_mgold$elm_random_pcg$Random_Pcg$independentSeed);
var _robertjlooby$elm_html5_drag_and_drop$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'NoOp':
			...
			case 'AddNewBoxList':
				var _p2 = A2(_mgold$elm_random_pcg$Random_Pcg$step, _robertjlooby$elm_html5_drag_and_drop$Main$boxListGenerator, model.seed);
				var newBoxList = _p2._0;
				var newSeed = _p2._1;
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						boxLists: A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: model.nextId, _1: newBoxList}
								])),
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						boxLists: A2(
							...
							function (_p3) {
								var _p4 = _p3;
								return !_elm_lang$core$Native_Utils.eq(_p4._0, _p1._0);
							},
							model.boxLists)
					});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ModifyBoxList':
				var updateById = function (_p5) {
					var _p6 = _p5;
					var _p8 = _p6._0;
					var _p7 = _p6._1;
					return _elm_lang$core$Native_Utils.eq(_p8, _p1._0) ? {
						ctor: '_Tuple2',
						_0: _p8,
						_1: A2(_robertjlooby$elm_html5_drag_and_drop$BoxList$update, _p1._1, _p7)
					} : {ctor: '_Tuple2', _0: _p8, _1: _p7};
				};
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						boxLists: A2(_elm_lang$core$List$map, updateById, model.boxLists)
					});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'UpdateLastDragged':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							lastDragged: _elm_lang$core$Maybe$Just(_p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var _p9 = model.lastDragged;
				if (_p9.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var partitionedLists = A2(
						_elm_lang$core$List$map,
						function (_p10) {
							var _p11 = _p10;
							return {
								ctor: '_Tuple2',
								_0: _p11._0,
								_1: A2(_robertjlooby$elm_html5_drag_and_drop$BoxList$removeBox, _p9._0, _p11._1)
							};
						},
						model.boxLists);
					var draggedBox = _elm_lang$core$List$head(
						A2(
					...
					if (_p14.ctor === 'Nothing') {
						...
						var newBoxLists = A3(
							_elm_lang$core$List$foldr,
							F2(
								function (_p15, boxLists) {
									var _p16 = _p15;
									var _p18 = _p16._0;
									var _p17 = _p16._1._1;
									return _elm_lang$core$Native_Utils.eq(_p18, _p1._0) ? A2(
										_elm_lang$core$List_ops['::'],
										{
											ctor: '_Tuple2',
											_0: _p18,
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{boxLists: newBoxLists});
						return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
					}
				}
		}
	});
var _robertjlooby$elm_html5_drag_and_drop$Main$Model = F4(
	function (a, b, c, d) {
		return {boxLists: a, nextId: b, lastDragged: c, seed: d};
	});
var _robertjlooby$elm_html5_drag_and_drop$Main$NoOp = {ctor: 'NoOp'};
var _robertjlooby$elm_html5_drag_and_drop$Main$HandleDropped = function (a) {
	return {ctor: 'HandleDropped', _0: a};
};
var _robertjlooby$elm_html5_drag_and_drop$Main$UpdateLastDragged = function (a) {
	return {ctor: 'UpdateLastDragged', _0: a};
};
var _robertjlooby$elm_html5_drag_and_drop$Main$ModifyBoxList = F2(
	function (a, b) {
		return {ctor: 'ModifyBoxList', _0: a, _1: b};
	});
var _robertjlooby$elm_html5_drag_and_drop$Main$RemoveBoxList = function (a) {
	return {ctor: 'RemoveBoxList', _0: a};
};
var _robertjlooby$elm_html5_drag_and_drop$Main$boxListView = function (_p19) {
	var _p20 = _p19;
	var _p21 = _p20._0;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Json_Decode$map,
					_robertjlooby$elm_html5_drag_and_drop$Main$UpdateLastDragged,
					A2(
						_elm_lang$core$Json_Decode$at,
						_elm_lang$core$Native_List.fromArray(
							['target', 'id']),
						_robertjlooby$elm_html5_drag_and_drop$Main$uuidDecoder))),
				A2(
				_elm_lang$html$Html_Events$on,
				'drop',
				_elm_lang$core$Json_Decode$succeed(
					_robertjlooby$elm_html5_drag_and_drop$Main$HandleDropped(_p21))),
				A3(
				_elm_lang$html$Html_Events$onWithOptions,
				'dragover',
				{preventDefault: true, stopPropagation: true},
				_elm_lang$core$Json_Decode$succeed(_robertjlooby$elm_html5_drag_and_drop$Main$NoOp))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html_App$map,
				_robertjlooby$elm_html5_drag_and_drop$Main$ModifyBoxList(_p21),
				_robertjlooby$elm_html5_drag_and_drop$BoxList$view(_p20._1)),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_robertjlooby$elm_html5_drag_and_drop$Main$RemoveBoxList(_p21))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _robertjlooby$elm_html5_drag_and_drop$Main$AddNewBoxList = {ctor: 'AddNewBoxList'};
var _robertjlooby$elm_html5_drag_and_drop$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _robertjlooby$elm_html5_drag_and_drop$Main$boxListView, model.boxLists)),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_robertjlooby$elm_html5_drag_and_drop$Main$AddNewBoxList)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Add new list')
					]))
			]));
};
var _robertjlooby$elm_html5_drag_and_drop$Main$main = {
	main: function () {
		var initialModel = A4(
			_robertjlooby$elm_html5_drag_and_drop$Main$Model,
			_elm_lang$core$Native_List.fromArray(
				[]),
			0,
			_elm_lang$core$Maybe$Nothing,
			_mgold$elm_random_pcg$Random_Pcg$initialSeed(0));
		return _elm_lang$html$Html_App$program(
			{
				init: {ctor: '_Tuple2', _0: initialModel, _1: _elm_lang$core$Platform_Cmd$none},
				view: _robertjlooby$elm_html5_drag_and_drop$Main$view,
				update: _robertjlooby$elm_html5_drag_and_drop$Main$update,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _robertjlooby$elm_html5_drag_and_drop$Main$main === 'undefined' ? null : _robertjlooby$elm_html5_drag_and_drop$Main$main);
