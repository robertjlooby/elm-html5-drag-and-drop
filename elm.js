...
Elm.Box.make = function (_elm) {
   ...
   var view = function (model) {
      var color = $Color.toRgb(model.color);
      var colorCss = A2($Basics._op["++"],
      "rgb(",
      A2($Basics._op["++"],
      ...
      A2($Basics._op["++"],
      ",",
      A2($Basics._op["++"],$Basics.toString(color.blue),")"))))));
      var boxStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                     ,_0: "backgroundColor"
                                                     ,_1: colorCss}
      ...
      _U.list([boxStyle
              ...
              ,$Html$Attributes.id($Uuid.toString(model.id))]),
      _U.list([]));
   };
   var Model = F2(function (a,b) {    return {color: a,id: b};});
   return _elm.Box.values = {_op: _op,Model: Model,view: view};
};
Elm.BoxList = Elm.BoxList || {};
Elm.BoxList.make = function (_elm) {
   "use strict";
   _elm.BoxList = _elm.BoxList || {};
   if (_elm.BoxList.values) return _elm.BoxList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Uuid = Elm.Uuid.make(_elm);
   var _op = {};
   var removeBox = F2(function (id,model) {
      var _p0 = A3($List.foldr,
      F2(function (box,_p1) {
         var _p2 = _p1;
         var _p3 = _p2._1;
         return _U.eq(box.id,id) ? {ctor: "_Tuple2"
                                   ,_0: $Maybe.Just(box)
                                   ,_1: _p3} : {ctor: "_Tuple2"
                                               ,_0: _p2._0
                                               ,_1: A2($List._op["::"],box,_p3)};
      }),
      {ctor: "_Tuple2",_0: $Maybe.Nothing,_1: _U.list([])},
      model.boxes);
      var removedBox = _p0._0;
      var listWithoutRemovedBox = _p0._1;
      return {ctor: "_Tuple2"
             ,_0: removedBox
             ,_1: _U.update(model,{boxes: listWithoutRemovedBox})};
   });
   var boxGenerator = function () {
      var intGenerator = A2($Random$PCG.$int,0,255);
      var colorGenerator = A4($Random$PCG.map3,
      $Color.rgb,
      intGenerator,
      intGenerator,
      intGenerator);
      return A3($Random$PCG.map2,
      $Box.Model,
      colorGenerator,
      $Uuid.uuidGenerator);
   }();
   var update = F2(function (action,model) {
      var _p4 = action;
      var _p5 = A2($Random$PCG.generate,boxGenerator,model.seed);
      var newBox = _p5._0;
      var newSeed = _p5._1;
      return _U.update(model,
      {boxes: A2($List.append,model.boxes,_U.list([newBox]))
      ,seed: newSeed});
   });
   var AddBox = {ctor: "AddBox"};
   var view = F2(function (address,model) {
      var boxesStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "border"
                                                       ,_1: "black solid"}
      ...
      _U.list([A2($Html$Events.onClick,address,AddBox)]),
      _U.list([$Html.text("+")]))]),
      A2($List.map,$Box.view,model.boxes)));
   });
   var Model = F2(function (a,b) {    return {boxes: a,seed: b};});
   return _elm.BoxList.values = {_op: _op
                                ,Model: Model
                                ,AddBox: AddBox
...
Elm.Main.make = function (_elm) {
   ...
   $Uuid = Elm.Uuid.make(_elm);
   var _op = {};
   var uuidDecoder = A2($Json$Decode.customDecoder,
   $Json$Decode.string,
   function (_p0) {
   ...
   var boxListGenerator = A2($Random$PCG.map,
   $BoxList.Model(_U.list([])),
   $Random$PCG.independentSeed);
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "NoOp": return {ctor: "_Tuple2"
                           ,_0: model
                           ,_1: $Effects.none};
         case "AddNewBoxList": var _p2 = A2($Random$PCG.generate,
           boxListGenerator,
           model.seed);
           var newBoxList = _p2._0;
           var newSeed = _p2._1;
           var newModel = _U.update(model,
           {boxLists: A2($List.append,
           model.boxLists,
           _U.list([{ctor: "_Tuple2",_0: model.nextId,_1: newBoxList}]))
           ,nextId: model.nextId + 1
           ,seed: newSeed});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "RemoveBoxList": var newModel = _U.update(model,
           {boxLists: A2($List.filter,
           function (_p3) {
              var _p4 = _p3;
              return !_U.eq(_p4._0,_p1._0);
           },
           model.boxLists)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "ModifyBoxList": var updateById = function (_p5) {
              var _p6 = _p5;
              var _p8 = _p6._0;
              var _p7 = _p6._1;
              return _U.eq(_p8,_p1._0) ? {ctor: "_Tuple2"
                                         ,_0: _p8
                                         ,_1: A2($BoxList.update,_p1._1,_p7)} : {ctor: "_Tuple2"
                                                                                ,_0: _p8
                                                                                ,_1: _p7};
           };
           var newModel = _U.update(model,
           {boxLists: A2($List.map,updateById,model.boxLists)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "UpdateLastDragged": return {ctor: "_Tuple2"
                                          ,_0: _U.update(model,{lastDragged: $Maybe.Just(_p1._0)})
                                          ,_1: $Effects.none};
         default: var _p9 = model.lastDragged;
           if (_p9.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 var partitionedLists = A2($List.map,
                 function (_p10) {
                    var _p11 = _p10;
                    return {ctor: "_Tuple2"
                           ,_0: _p11._0
                           ,_1: A2($BoxList.removeBox,_p9._0,_p11._1)};
                 },
                 model.boxLists);
                 var draggedBox = $List.head(A2($List.filterMap,
                 function (_p12) {
                    var _p13 = _p12;
                    return _p13._1._0;
                 },
                 ...
                 if (_p14.ctor === "Nothing") {
                       ...
                       var newBoxLists = A3($List.foldr,
                       F2(function (_p15,boxLists) {
                          var _p16 = _p15;
                          var _p18 = _p16._0;
                          var _p17 = _p16._1._1;
                          return _U.eq(_p18,_p1._0) ? A2($List._op["::"],
                          {ctor: "_Tuple2"
                          ,_0: _p18
                          ,_1: _U.update(_p17,
                          {boxes: A2($List.append,_p17.boxes,_U.list([_p14._0]))})},
                          boxLists) : A2($List._op["::"],
                          {ctor: "_Tuple2",_0: _p18,_1: _p17},
                          boxLists);
                       }),
                       _U.list([]),
                       partitionedLists);
                       var newModel = _U.update(model,{boxLists: newBoxLists});
                       return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
                    }
              }}
   });
   var NoOp = {ctor: "NoOp"};
   var HandleDropped = function (a) {
      return {ctor: "HandleDropped",_0: a};
   };
   var UpdateLastDragged = function (a) {
      return {ctor: "UpdateLastDragged",_0: a};
   };
   var ModifyBoxList = F2(function (a,b) {
      return {ctor: "ModifyBoxList",_0: a,_1: b};
   });
   var RemoveBoxList = function (a) {
      return {ctor: "RemoveBoxList",_0: a};
   };
   var boxListView = F2(function (address,_p19) {
      var _p20 = _p19;
      var _p23 = _p20._0;
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
              ...
              ,A3($Html$Events.on,
              "dragstart",
              A2($Json$Decode.at,_U.list(["target","id"]),uuidDecoder),
              function (boxId) {
                 return A2($Signal.message,address,UpdateLastDragged(boxId));
              })
              ,A3($Html$Events.on,
              "drop",
              $Json$Decode.succeed("dropped"),
              function (_p21) {
                 return A2($Signal.message,address,HandleDropped(_p23));
              })
              ,A4($Html$Events.onWithOptions,
              "dragover",
              {preventDefault: true,stopPropagation: true},
              $Json$Decode.succeed("dragged over"),
              function (_p22) {
                 return A2($Signal.message,address,NoOp);
              })]),
      _U.list([A2($BoxList.view,
              A2($Signal.forwardTo,address,ModifyBoxList(_p23)),
              _p20._1)
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,RemoveBoxList(_p23))]),
              _U.list([$Html.text("Remove")]))]));
   });
   var AddNewBoxList = {ctor: "AddNewBoxList"};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([]),
              A2($List.map,boxListView(address),model.boxLists))
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,AddNewBoxList)]),
              _U.list([$Html.text("Add new list")]))]));
   });
   ...
   return _elm.Main.values = {_op: _op
                             ,Model: Model
                             ,AddNewBoxList: AddNewBoxList
                             ,RemoveBoxList: RemoveBoxList
                             ,ModifyBoxList: ModifyBoxList
                             ,UpdateLastDragged: UpdateLastDragged
                             ,HandleDropped: HandleDropped
                             ,NoOp: NoOp
                             ,boxListGenerator: boxListGenerator
                             ,update: update
                             ,view: view
                             ,uuidDecoder: uuidDecoder
