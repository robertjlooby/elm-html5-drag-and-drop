...
Elm.Box.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F2(function (index,model) {
      ...
      _U.list([boxStyle
              ...
              ,$Html$Attributes.id($Basics.toString(index))]),
      _U.list([]));
   });
   var Model = function (a) {    return {color: a};};
...
Elm.BoxList.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      var _p1 = A2($Random$PCG.generate,colorGenerator,model.seed);
      var color = _p1._0;
      var newSeed = _p1._1;
      var newBox = $Box.Model(color);
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([$Html.text("+")]))]),
      A2($List.indexedMap,$Box.view,model.boxes)));
   });
...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2"
                           ,_0: model
                           ,_1: $Effects.none};
         case "AddNewBoxList": var _p1 = A2($Random$PCG.generate,
           boxListGenerator,
           model.seed);
           var newBoxList = _p1._0;
           var newSeed = _p1._1;
         ...
         case "RemoveBoxList": var newModel = _U.update(model,
           ...
           function (_p2) {
              var _p3 = _p2;
              return !_U.eq(_p3._0,_p0._0);
           },
           model.boxLists)});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "ModifyBoxList": var updateById = function (_p4) {
              var _p5 = _p4;
              var _p7 = _p5._0;
              var _p6 = _p5._1;
              return _U.eq(_p7,_p0._0) ? {ctor: "_Tuple2"
                                         ,_0: _p7
                                         ,_1: A2($BoxList.update,_p0._1,_p6)} : {ctor: "_Tuple2"
                                                                                ,_0: _p7
                                                                                ,_1: _p6};
           };
           var newModel = _U.update(model,
         ...
         case "UpdateLastDragged": return {ctor: "_Tuple2"
                                          ,_0: _U.update(model,
                                          {lastDragged: $Maybe.Just({ctor: "_Tuple2"
                                                                    ,_0: _p0._0._0
                                                                    ,_1: _p0._0._1})})
                                          ,_1: $Effects.none};
         default: var _p8 = model.lastDragged;
           if (_p8.ctor === "Nothing") {
                 return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
              } else {
                 var _p24 = _p8._0._1;
                 var _p9 = A3($List.foldr,
                 F2(function (_p11,_p10) {
                    ...
                    var _p13 = _p10;
                    var _p16 = _p13._1;
                    if (_U.eq(_p8._0._0,_p18)) {
                          var listWithoutDroppedBox = A2($List.map,
                          $Basics.snd,
                          A2($List.filter,
                          function (_p14) {
                             var _p15 = _p14;
                             return !_U.eq(_p15._0,_p24);
                          },
                          A2($List.indexedMap,
                          F2(function (v0,v1) {
                             return {ctor: "_Tuple2",_0: v0,_1: v1};
                          ...
                          _p17.boxes)));
                          var boxListWithoutDroppedBox = _U.update(_p17,
                          {boxes: listWithoutDroppedBox});
                          var droppedBox = $List.head(A2($List.drop,_p24,_p17.boxes));
                          return {ctor: "_Tuple2"
                                 ,_0: droppedBox
                                 ,_1: A2($List._op["::"],
                                 {ctor: "_Tuple2",_0: _p18,_1: boxListWithoutDroppedBox},
                                 _p16)};
                       } else return {ctor: "_Tuple2"
                                     ,_0: _p13._0
                                     ,_1: A2($List._op["::"],
                 ...
                 model.boxLists);
                 var draggedBox = _p9._0;
                 var boxListsWithoutDraggedBox = _p9._1;
                 var _p19 = draggedBox;
                 if (_p19.ctor === "Nothing") {
                       return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                    } else {
                       var newBoxLists = A2($List.map,
                       function (_p20) {
                          var _p21 = _p20;
                          var _p23 = _p21._0;
                          var _p22 = _p21._1;
                          return _U.eq(_p23,_p0._0) ? {ctor: "_Tuple2"
                                                      ,_0: _p23
                                                      ,_1: _U.update(_p22,
                                                      {boxes: A2($List.append,
                                                      _p22.boxes,
                                                      _U.list([_p19._0]))})} : {ctor: "_Tuple2",_0: _p23,_1: _p22};
                       },
                       boxListsWithoutDraggedBox);
                       return {ctor: "_Tuple2"
                              ,_0: _U.update(model,{boxLists: newBoxLists})
                              ,_1: $Effects.none};
                    }
              }}
   });
   ...
   var boxListView = F2(function (address,_p25) {
      var _p26 = _p25;
      var _p29 = _p26._0;
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
              ...
              function (boxId) {
                 ...
                 address,
                 UpdateLastDragged({ctor: "_Tuple2"
                                   ,_0: _p29
                                   ,_1: A2($Maybe.withDefault,
                                   -1,
                                   $Result.toMaybe($String.toInt(boxId)))}));
              })
              ,A3($Html$Events.on,
              "drop",
              $Json$Decode.succeed("dropped"),
              function (_p27) {
                 return A2($Signal.message,address,HandleDropped(_p29));
              })
      ...
      _U.list([A2($BoxList.view,
              A2($Signal.forwardTo,address,ModifyBoxList(_p29)),
              _p26._1)
              ,A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,RemoveBoxList(_p29))]),
